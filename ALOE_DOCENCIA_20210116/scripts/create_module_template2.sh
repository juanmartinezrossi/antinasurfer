...
ls -al module_template2.ALOE1.6NOV15
pwd
...
rm $SOURCE0.ALOE1.6NOV15/debug_make/libmodule_template2.a
rm $SOURCE0.ALOE1.6NOV15/debug_make/module_template2
rm $SOURCE0.ALOE1.6NOV15/lnx_make/Makefile
rm $SOURCE0.ALOE1.6NOV15/lnx_make/Makefile.in
rm $SOURCE0.ALOE1.6NOV15/aloe/skeleton/*.o
rm $SOURCE0.ALOE1.6NOV15/aloe/standalone/*.o
rm $SOURCE0.ALOE1.6NOV15/aloe/extern/*.o
rm $SOURCE0.ALOE1.6NOV15/aloe/gnuplot/*.o
rm $SOURCE0.ALOE1.6NOV15/lnx_make/bin/module_template2
rm $SOURCE0.ALOE1.6NOV15/matlab/module_template2.mexglx
rm $SOURCE0.ALOE1.6NOV15/matlab/module_template2.mex
rm $SOURCE0.ALOE1.6NOV15/src/*.om
rm $SOURCE0.ALOE1.6NOV15/src/*.o
rm $SOURCE0.ALOE1.6NOV15/standalone/*.o

SOURCE1=$SOURCE0.ALOE1.6NOV15
printf 'SOURCE1=%s\n' "$SOURCE1"
